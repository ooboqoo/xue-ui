<template>
  <div class="xue-dist-select">
    <XueSelect
      :options="provOptions" :placeholder="placeholder.prov"
      :value="prov" @change="changeProv"
    />
    <XueSelect
      v-if="level > 1"
      :options="cityOptions" :placeholder="placeholder.city"
      :value="city" @change="changeCity"
    />
    <XueSelect
      v-if="level == 3"
      :options="distOptions" :placeholder="placeholder.dist"
      :value="dist" @change="changeDist"
    />
  </div>
</template>
